 ...
 */
export type PeerCreateStep =
	(typeof PEER_CREATE_STEPS)[keyof typeof PEER_CREATE_STEPS];
export type PeerModifyStep =
	(typeof PEER_MODIFY_STEPS)[keyof typeof PEER_MODIFY_STEPS];
