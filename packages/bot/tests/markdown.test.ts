...
describe('escapeMarkdown', () => {
    it('escapes underscores — DN42 peer names like KIOUBIT_NET must not crash Telegram Markdown parsing', () => {
...
describe('codeSafe', () => {
    it('replaces backticks with single quotes so they cannot break a code span', () => {
